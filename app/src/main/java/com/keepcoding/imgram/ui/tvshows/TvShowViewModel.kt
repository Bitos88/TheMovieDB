...
class TvShowViewModel @Inject constructor(private val repository: Repository, private val mapper: TvShowPresentationMapper) : ViewModel() {
    ...
    fun markTvShowAsFavorite(tvShowId: Long) {
        viewModelScope.launch {
            withContext(Dispatchers.IO) {
                val tvShow: TvShowItemData = repository.getTvShow(tvShowId)
                tvShow.favorite = tvShow.favorite != true
                repository.deleteTvShowById(tvShow.id!!)
